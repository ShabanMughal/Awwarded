...
setTransform('')
  ...
  return(
    <div className={className} ref={itemRef} onMouseMove={handleMouseMove} onMouseLeave={handleMouseLeave} style={{transform: transform}}>
{children}
    </div>
    ...
    <section className='bg-black pb-52'>
      <div className='container mx-auto px-3 md:px-10'>
        <div className='px-5 py-32'>
          ...
          <p className='max-x-md font-circular-web text-lg text-blue-50 opacity-50'>
            Immerce yourself in a rich and ever-expanding universe where a vibrant array of product converge into an interconnected overly experince on your world.
          </p>
          </div> 
      
      <BentoTilt className='border-hsla relative mb-7 h-96 w-full overflow-hidden rounded-md md:h-[65vh]'>
        <BentoCard src='videos/feature-1.mp4' title={<>radi<b>n</b>t</>} description="A cross-platform metagame app, turning your activites across Web2 and Web3 games into a rewarding adventure." />
      </BentoTilt>
      <div className='grid h-[135vh] grid-cols-2 grid-rows-3 gap-7'>
        ...
        <BentoTilt className='bento-tilt_1 me-14 md:col-span-1 md:me-0'>
          <BentoCard src="videos/feature-4.mp4" title={<>az<b>u</b>xl</>} description='A cross-world AI Agent - elevating your gameplay to be more fun and productive.' />
        </BentoTilt>
        ...
        <dBentoTiltiv className='bento-tilt_2'>
